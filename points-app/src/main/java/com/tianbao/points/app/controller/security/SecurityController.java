...
public class SecurityController {
    ...
    public OutputResult<JwtToken> login(@RequestBody @Valid LoginInput loginInput) throws ApplicationException {
        ...
        if(user == null) {
            ...
            throw new ApplicationException(ApplicationException.ACCOUNT_PARAM_ERROR, "app端用户账号错误，未查询到用户");
        }
        //必须为会员，非会员则返回错误
        ...
        if(roleList == null || roleList.size() <= 0 || roleList.get(0) == null ||
            ...
            throw new ApplicationException(ApplicationException.ACCOUNT_PARAM_ERROR, "app端用户账号错误，会员角色查询有误");
        }
        String encoded = null;
        try {
